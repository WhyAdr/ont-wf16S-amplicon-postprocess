...
Version 0.3.1 is validated against the tracked `wf-16s` minimap2 abundance,
...
- `input.params_json` is required. Version 0.3.1 accepts minimap2, species-rank
...
an environment. Version 0.3.1 is therefore provenance-captured, not bitwise
...
Version 0.3.1 covers validated NCBI/minimap2/species parsing, exact read accounting, single-sample summaries, synthetically
