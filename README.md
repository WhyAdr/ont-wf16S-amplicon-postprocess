...
Current pipeline version: **0.4.6**.
...
Version 0.4.6 is validated against the tracked `wf-16s` minimap2 abundance,
...
- `input.params_json` is required. Version 0.4.6 accepts minimap2, species-rank
...
Version 0.4.6 maintains manifest schema v2 (revision 2) and its machine-readable shape
...
Version 0.4.6 covers validated NCBI/minimap2/species parsing, exact read accounting,
...
reserved/skipped; version `0.4.6` follows the published `0.4.5` release.
