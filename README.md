...
Current pipeline version: **0.4.1**.
...
Version 0.4.1 is validated against the tracked `wf-16s` minimap2 abundance,
...
- `input.params_json` is required. Version 0.4.1 accepts minimap2, species-rank
...
Version 0.4.1 maintains manifest schema v2 (revision 1); this is a machine-readable shape
...
Version 0.4.1 covers validated NCBI/minimap2/species parsing, exact read accounting, single-sample summaries, synthetically
